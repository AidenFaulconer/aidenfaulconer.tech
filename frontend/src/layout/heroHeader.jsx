...
export const HeroHeader = React.memo(({ id, noHeadline = false, ...props }) => {
  ...
  return (
    <section id={id}>
      <Grid
        container
        className="w-full py-24 h-full box-border relative inline-flex justify-center"
        sx={{
      ...
      >
        ...
        <Grid
          item
          sm={12}
          className="relative z-[1] w-full h-3/4 lg:min-h-[55vh] md:min-h-[55vh] md:max-h-[30vh] inline-flex max-h-3/4 mt-0 m-auto"
        >
          <Box
        ...
        {!heroData.enabled || (
          <Grid
            item
            sm={12}
            className="align-middle justify-center inline-flex"
          >
            <Grid
              item
              xs={8}
              className="inline-flex gap-4 justify-center flex-col relative m-auto h-2/6 pointer-events-none p-3 "
              sx={{
            ...
            >
              <Typography
                ...
                color="secondary"
                variant="h2"
                className="z-[1] uppercase"
              >
                {heroData.description}
              </Typography>

              <Typography
                className="max-w-[556px] z-[1]"
                variant="body1"
                color="secondary"
                align="left"
              >
              ...
              {/* Buttons */}
              {heroData.ctas === false || (
                <Box className="pt-3 pointer-events-[all] inline-flex gap-2 justify-start items-start relative z-20 max-w-[556px]">
