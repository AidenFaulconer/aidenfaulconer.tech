...
export const CUSTOM_THEME_PROPS = {
  shape: {
    ...
    brandBorderSecondary: '1px solid rgba(1,1,1,.3)',
  },
  brandShadows: {
...
const LIGHT_THEME = {
  ...
  brandShadows: {
    brand: '-20px 34px 110px rgba(0, 0, 100, 0.1);',
    filterShadow: '0px 0px 20px rgba(51, 68, 9,.6)',
    brandBig: '10px 10px 0px rgba(183, 197, 168, 0.6), 5px 5px 0px rgba(183, 197, 168, 0.6), 46px 31px 75px rgba(0, 0, 0, 0.3)',
    brandInset: 'inset -0px 0px 50px rgba(0, 0, 100, 0.15)',
  },
  //
  palette: {
    type: 'light',
...
export const patternHover = {
  ...
  '&:hover': {
    borderRadius: _theme.shape.brandBorderRadius,
...
const commonButton = {
  root: {
    transition,
    boxShadow: _theme.brandShadows.brand,
    color: _theme.palette.background.default,
    borderRadius: `${_theme.shape.brandBorderRadius} !important`,
    padding: spacing(1),
    whiteSpace: 'nowrap',
    // display: 'inline',
...
export {
  TYPOGRAPHY, LIGHT_THEME, DARK_THEME, OVERRIDES,
};
