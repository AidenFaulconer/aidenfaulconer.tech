...
const Consolelogs = () => {
  ...
  useEffect(() => {
    ...
    if (process.env.production) {
      // eslint-disable-next-line quotes
      alert("/nHello visitor! /n/nYou are viewing a preview of this new site, come back in a few days to see a completed version.../nand see everything I have to offer!/n/nBest Regards - Aiden Faulconer/n");
    }
  }, []);
  return (<></>);
};
