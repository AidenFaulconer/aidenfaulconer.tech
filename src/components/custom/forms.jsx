...
// import {
//   sendSms,
//   getLocationByLatyLng,
//   postToSpreadsheeets,
// } from '../utils/apis';
// // import { google } from 'googleapis';
// import { GoldButton, RegularButton } from './buttons';
// import {
//   CalenderInput,
//   DropDownButton,
//   SliderInput,
...
//       message: `
//     -------------------------
//     ${name} has booked a ${capitalizeFirstLetter(
//   categories[selectedCategory].services[selectedSubCategory],
// )} service for ${totalCost}.
//     -------------------------
...
//       message: `
//         -------------------------
//         Hello ${name}! youve been quoted a ${capitalizeFirstLetter(
//   categories[selectedCategory].services[selectedSubCategory],
// )} service for ${totalCost}.
//         -------------------------
...
//     const longitude = userData.location?.longitude
//       || ajGardenCareStats.location.longitude + 0.01;
...
//     // calculate the distance between two geolocation points (lattitude and longetude)
//     const travelCost = Number(
//       Math.round(
//         calculateDistance(
//           ajGardenCareStats.location.latitude,
//           ajGardenCareStats.location.longitude,
//           latitude,
//           longitude,
//         ) * gasRate,
//       ),
//     ).toFixed(truncateAmount);
...
//     const categoryCostPerMeterSquared = Number(
//       Math.round(currentQuote.meters /** * 2 */) * meterRate,
//     ).toFixed(truncateAmount);
...
//     const totalCost = [
//       Number(baseCost),
//       Number(categoryCostPerMeterSquared),
//       Number(travelCost),
//     ].reduce((pre, cur) => (pre && pre + cur) || cur);
...
//         subService,
//       )} estimation`]: categoryCostPerMeterSquared,
...
//     () => quoteCalculatorState
//       && bookingState
//       && new Promise((resolve) => calculateTotalCost(quoteCalculatorState, bookingState)),
//     [quoteCalculatorState, bookingState],
//   );
...
//   const checkBookingState = React.useCallback(
//     (jsx = {}) => Object.keys(invoiceState).map((key) => invoiceState[key] > 0),
//     [invoiceState],
//   );
...
//   //     booking status
//   // ========================================================================== //\
//   const checkSmsStatus = React.useCallback(
//     () => (status === 'success' ? 1 : status === 'pending' ? 2 : 0),
//     [status],
//   );

//   const bookingStatus = () => {
//     const handleClose = React.useCallback(
//       () => (checkSmsStatus() && toggleQuoteFinished()) || togglePopup(),
//       [popup],
//     );
//     return (
//       <Modal
...
//   useEffect(() => calculateUserInputs({ location: coords }), [
//     coords,
//     quoteState,
//   ]);
...
//       >
//         <Gridify breakpointSizes={breakPointSizes}>
...
//           <SliderInput
//             label="how large is the area being worked on? (In meters)"
//             defaultValue={2}
//             value={2}
//             step={1.25}
//             max={20}
//             valueLabelDisplay="on"
//             onChange={(value) => calculateInputs({ meters: value })}
//           />
//         </Gridify>
//       </Grid>
...
//             <TextInput
//               InputProps={{
//                 startAdornmant: <InputAdornment position="start" />,
//               }}
//               error={false}
...
//             <RegularButton
//               onClick={(e) => {
//                 geolocationSelfRef.current.getLocation();
//               }}
//             >
...
//   useEffect(() => setValue(quoteState?.selectedCategory || 0), [
//     quoteState,
//     bookingState,
//   ]);
