...
// import { BtnPrimary, BtnBlob, BtnSecondary } from "../../components/buttons";
...
//   // const { olorSwap } = useContext(GlobalStore);
...
//         //#region set blog context
//         let { blogContext } = useContext(GlobalStore);
//         const [pageContext, setPageContext] = useState(processedData);
//         useEffect(() => {
//           blogContext = pageContext;
//         }, [pageContext]);
//         //#endregion set blog context
...
//                         data-scroll
//                         data-scroll-call="call"
//                       >
//                         <div className="content" key={`${sectionName} content`}>
